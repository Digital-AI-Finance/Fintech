...
\begin{frame}{From Abacus to Algorithm -- A Timeline}
  \begin{center}
    \includegraphics[width=0.90\textwidth]{01_fintech_evolution_timeline/chart.pdf}
  \end{center}
  \vspace{-0.3em}
  \begin{itemize}
...
\begin{frame}{How Fintech Unbundles the Bank}
  \begin{center}
    \includegraphics[width=0.88\textwidth]{02_banking_value_chain_disruption/chart.pdf}
  \end{center}
  \vspace{-0.2em}
  \begin{itemize}
...
\begin{frame}{Before 2008 -- The Trust Assumption}
  \begin{columns}[T]
    ...
    \end{column}
    \begin{column}{0.41\textwidth}
      \includegraphics[width=\textwidth]{05_great_recession_catalyst/chart.pdf}
    \end{column}
  \end{columns}
...
\begin{frame}{The Post-Crisis Fintech Boom}
  \begin{center}
    \includegraphics[width=0.85\textwidth]{06_fintech_investment_growth/chart.pdf}
  \end{center}
  \vspace{-0.2em}
  \begin{itemize}
...
\begin{frame}{The Collaboration Spectrum}
  \begin{center}
    \includegraphics[width=0.88\textwidth]{03_collaboration_models_matrix/chart.pdf}
  \end{center}
  \vspace{-0.2em}
  \begin{itemize}
...
\begin{frame}{Fintech Around the World -- Regional Patterns}
  \begin{center}
    \includegraphics[width=0.88\textwidth]{09_fintech_impact_comparison/chart.pdf}
  \end{center}
  \vspace{-0.3em}
  \begin{itemize}
