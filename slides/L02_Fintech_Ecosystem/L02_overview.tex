...
\begin{frame}{What Is Driving the Fintech Explosion?}
  \begin{center}
    \includegraphics[width=0.88\textwidth]{02_growth_drivers_dashboard/chart.pdf}
  \end{center}
  \vspace{-0.3em}
  \begin{itemize}
...
\begin{frame}{The Inclusion Gap -- Who Is Still Left Out?}
  \begin{center}
    \includegraphics[width=0.88\textwidth]{03_financial_inclusion_gap/chart.pdf}
  \end{center}
  \vspace{-0.3em}
  \begin{itemize}
...
\begin{frame}{Trust in Fintech -- A Three-Dimensional Framework}
  \begin{center}
    \includegraphics[width=0.88\textwidth]{05_trust_framework_comparison/chart.pdf}
  \end{center}
  \vspace{-0.3em}
  \begin{itemize}
...
\begin{frame}{Where Is Your Product? The Adoption Lifecycle}
  \begin{center}
    \includegraphics[width=0.88\textwidth]{06_technology_adoption_lifecycle/chart.pdf}
  \end{center}
  \vspace{-0.3em}
  \begin{itemize}
...
\begin{frame}{Five Nudges That Work in Fintech}
  \begin{center}
    \includegraphics[width=0.88\textwidth]{08_nudging_architecture/chart.pdf}
  \end{center}
  \vspace{-0.3em}
  \begin{columns}[T]
...
\begin{frame}{The Fintech Ecosystem -- Who Holds the Power?}
  \begin{center}
    \includegraphics[width=0.88\textwidth]{10_ecosystem_stakeholder_impact/chart.pdf}
  \end{center}
  \vspace{-0.3em}
  \begin{itemize}
