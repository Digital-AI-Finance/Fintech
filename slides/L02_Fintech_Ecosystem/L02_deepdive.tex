...
\begin{frame}{Trust Measurement Models: From Construct to Operationalisation}
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
      \begin{center}
        \includegraphics[width=0.95\textwidth]{05_trust_framework_comparison/chart.pdf}
      \end{center}
    \end{column}
...
\begin{frame}{Growth Drivers: A Critical Examination of the Standard Narrative}
  \begin{columns}[T]
    \begin{column}{0.55\textwidth}
      \begin{center}
        \includegraphics[width=0.96\textwidth]{06_technology_adoption_lifecycle/chart.pdf}
      \end{center}
    \end{column}
    \begin{column}{0.42\textwidth}
...
\begin{frame}{Advanced Choice Architecture: Sunstein's Taxonomy and the Paternalism Debate}
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
      \begin{center}
        \includegraphics[width=0.95\textwidth]{08_nudging_architecture/chart.pdf}
      \end{center}
    \end{column}
    \begin{column}{0.45\textwidth}
...
\begin{frame}{Dark Patterns: Anatomy and Regulatory Response}
  \begin{columns}[T]
    \begin{column}{0.55\textwidth}
      \begin{center}
        \includegraphics[width=0.96\textwidth]{09_choice_architecture_examples/chart.pdf}
      \end{center}
    \end{column}
    \begin{column}{0.42\textwidth}
...
\begin{frame}{Inclusion-Protection Tension: Policy Design Principles}
  \begin{columns}[T]
    \begin{column}{0.55\textwidth}
      \begin{center}
        \includegraphics[width=0.96\textwidth]{10_ecosystem_stakeholder_impact/chart.pdf}
      \end{center}
    \end{column}
    \begin{column}{0.42\textwidth}
...
\begin{frame}{Adoption Lifecycle: Mathematical Foundations}
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
      \begin{center}
        \includegraphics[width=0.95\textwidth]{06_technology_adoption_lifecycle/chart.pdf}
      \end{center}
    \end{column}
    \begin{column}{0.45\textwidth}
