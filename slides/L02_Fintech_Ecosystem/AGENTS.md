...
|------|---------|----------|--------|
| `L02_full.tex` | Primary lecture deck (31 frames) | Instructors, students | Production |
| `L02_overview.tex` | Condensed overview (26 frames) | Quick reference | Production |
| `L02_deepdive.tex` | Analytical variant with appendix (17 frames) | Deep learners | Production |
| `L02_core.tex` | Extracted 10-frame core (self-contained) | Standalone teaching | Production |
| `L02_mini10.tex` | 11-frame teaser with TikZ diagrams | Promotional | Production |
| `L02_mini5.tex` | 5-slide arc (WHY > WHAT > HOW > WHERE > SO WHAT) | Lightning talks | Production |
...
```bash
cd slides/L02_Fintech_Ecosystem
