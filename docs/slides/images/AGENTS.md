...
|-----------|---------|---------|
| `src` | Image path | `../slides/images/L01/chart_name.png` |
...
2. **Create directory** `slides/images/L0{N}/`
...
- **Downloads**: `../pdf/AGENTS.md` — PDF variants (may embed chart PNGs)
- **Source Materials**: `D:/Joerg/Research/slides/Fintech/slides/L01_Fintech_Foundations/` — Original slide decks
