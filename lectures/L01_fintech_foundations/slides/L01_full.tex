...
\begin{frame}{From Abacus to Algorithm --- A Timeline of Financial Innovation}
  \begin{center}
    \includegraphics[width=0.88\textwidth]{figures/01_fintech_evolution_timeline/chart.pdf}
  \end{center}
  \vspace{-0.3em}
  \begin{itemize}
...
\begin{frame}{Traditional Banking vs.\ Fintech --- What Changed?}
  \begin{center}
    \includegraphics[width=0.85\textwidth]{figures/02_banking_value_chain_disruption/chart.pdf}
  \end{center}
  \vspace{-0.3em}
  \begin{itemize}
...
\begin{frame}{The 2008 Crisis --- Trust Collapses}
  \begin{center}
    \includegraphics[width=0.82\textwidth]{figures/05_great_recession_catalyst/chart.pdf}
  \end{center}
  \vspace{-0.3em}
  \begin{itemize}
...
\begin{frame}{Post-Crisis Fintech Boom --- The Numbers}
  \begin{center}
    \includegraphics[width=0.82\textwidth]{figures/06_fintech_investment_growth/chart.pdf}
  \end{center}
  \vspace{-0.3em}
  \begin{itemize}
...
\begin{frame}{Partnership Model --- How It Works}
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
      \includegraphics[width=\textwidth]{figures/07_bank_fintech_partnership_flow/chart.pdf}
    \end{column}
