...
\begin{frame}{The Most Important Branch}
  \begin{center}
    \includegraphics[width=0.85\textwidth]{figures/11_opening_cartoon/cartoon.pdf}
  \end{center}
  \vspace{-0.5em}
  \begin{center}
...
\begin{frame}{The Fintech Growth Engine --- Four Drivers}
  \begin{columns}[T]
    \begin{column}{0.50\textwidth}
      \includegraphics[width=\textwidth]{figures/02_growth_drivers_dashboard/chart.pdf}
    \end{column}
...
\begin{frame}{Financial Inclusion --- The Unbanked Challenge}
  \begin{columns}[T]
    \begin{column}{0.50\textwidth}
      \includegraphics[width=\textwidth]{figures/03_financial_inclusion_gap/chart.pdf}
    \end{column}
    \begin{column}{0.47\textwidth}
      \begin{itemize}
...
\begin{frame}{Trust in Financial Services --- A Framework}
  \begin{columns}[T]
    \begin{column}{0.50\textwidth}
      \includegraphics[width=\textwidth]{figures/05_trust_framework_comparison/chart.pdf}
    \end{column}
    \begin{column}{0.47\textwidth}
      \begin{itemize}
...
\begin{frame}{The Technology Adoption Lifecycle Applied to Fintech}
  \begin{columns}[T]
    \begin{column}{0.50\textwidth}
      \includegraphics[width=\textwidth]{figures/06_technology_adoption_lifecycle/chart.pdf}
    \end{column}
    \begin{column}{0.47\textwidth}
      \begin{itemize}
...
\begin{frame}{Risk Aversion Across Demographics}
  \begin{columns}[T]
    \begin{column}{0.50\textwidth}
      \includegraphics[width=\textwidth]{figures/07_adoption_barriers_matrix/chart.pdf}
    \end{column}
    \begin{column}{0.47\textwidth}
...
\begin{frame}{Choice Architecture --- Designing Financial Decisions}
  \begin{columns}[T]
    \begin{column}{0.50\textwidth}
      \includegraphics[width=\textwidth]{figures/08_nudging_architecture/chart.pdf}
    \end{column}
    \begin{column}{0.47\textwidth}
      \begin{itemize}
...
\begin{frame}{Fintech Ecosystem Stakeholder Map}
  \begin{columns}[T]
    \begin{column}{0.50\textwidth}
      \includegraphics[width=\textwidth]{figures/10_ecosystem_stakeholder_impact/chart.pdf}
    \end{column}
    \begin{column}{0.47\textwidth}
...
\begin{frame}{The Choice Architect}
  \begin{center}
    \includegraphics[width=0.85\textwidth]{figures/12_closing_cartoon/cartoon.pdf}
  \end{center}
  \vspace{-0.5em}
  \begin{center}
